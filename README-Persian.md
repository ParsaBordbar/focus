...
- به‌صورت خودکار از وب‌سایت‌های حواس‌پرت‌کن (مثل TikTok، Instagram، Shorts) ریدایرکت می‌کند  
- بخش‌های اعتیادآور مانند Shorts در یوتیوب را پنهان می‌کند  
- شما را به یک وب‌سایت مفید و تصادفی هدایت می‌کند  
...
افزونه به صورت خودکار این پوشه‌ها را خوانده و منطق مسدودسازی/ریدایرکت را به‌روزرسانی می‌کند.
